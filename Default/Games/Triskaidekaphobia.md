...
#### Brainwash:
##### Target twelve cards from the graveyards: for each card, either exile it or shuffle it into its owner's deck. Then, return one card from either graveyard to the field or hand.
...
##### Rank 1
##### Blue Spell
##### *Equip to opponent's summon: it becomes tapped. It cannot be untapped.*
...
##### Purple Spell
##### *Choose one:
##### - Reveal opponent's hand and discard a rank 2 or lower card from it.
##### - Target a rank 2 or lower card in your opponent's graveyard: banish it.
##### - Target a rank 2 or lower exiled card your opponent owns: shuffle it into the deck.*

#### Ritual Offers
##### Rank 1
##### Purple Spell
##### *Sudden.
##### Exile a summon you control; heal X yourself and summons you control, where X is its health. If your opponent owned it, MOVE 2.*

#### Taunting Illusion
##### Rank 1
##### Purple Summon 1/1 Aberration
##### *Sudden.
##### You may cast this summon from the exile
##### If an opponent's summon declares an attack: redirect the attack to this card.
##### You can only use each "Taunting Illusion's effect once per turn"*
...
##### Rank 2
##### Purple Spell
##### *Target a summon your opponent controls: take control of it until the end phase.*

#### Seize
##### Rank 2
##### Purple Spell
##### *Declare the name of a non-legendary card: look through your opponent's hand and deck, then if you find any card with the declared name, you can add one to your hand.*

#### Reflecting Mirror
##### Rank 2
##### Purple Spell
##### *Permanent.
##### Once per turn, you can target one revealed summon your opponent owns: shapeshift into that card until the end of this turn (it gains its power, health and effects.)
...
#### Divide and Conquer
##### Rank 3
##### Legendary Purple Spell
##### *Divide all cards your opponent controls into two piles. Your opponents chooses one, then sacrifices all cards in that pile.*
...
##### Purple Spell
##### *Choose two:
##### - Reveal your opponent's hand and discard a card from it.
##### - Target one card in your opponent's graveyard: banish it.
##### - Target one exiled card your opponent owns: shuffle it into the deck.
